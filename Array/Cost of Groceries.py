...
Chef visited a grocery store for fresh supplies. There are N items in the store where the i**th item has a 
freshness value Ai​ and cost Bi​.

Chef has decided to purchase all the items having a freshness value greater than equal to X. Find the total cost 
...
Test case 2: Items 1,2, and 3 have freshness value greater than equal to X=1. Thus, Chef buys all 3 items. 
The total cost is 1+2+3=6.

Test case 3: No item has freshness value greater than equal to X=100. Thus, Chef buys no items.

Test case 4: Items 2 and 3 have freshness value greater than equal to X=50. Thus, Chef buys items 2 and 3.
The total cost is 30+20=50.
"""
